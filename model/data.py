...
def process_data(
    ...
    """ Process the src_data used in the machine learning pipeline.

    Processes the src_data using one hot encoding for the categorical
    features and a
    ...
    functionality that
    scales the continuous src_data.
